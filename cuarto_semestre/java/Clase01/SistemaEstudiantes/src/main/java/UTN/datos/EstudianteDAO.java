...
public class EstudianteDAO {
    ...
    public List<Estudiante> listarEstudiantes(){
        ...
        PreparedStatement ps; // Ayuda a preparar (envia) la sentencia de SQL que ejecutaremos a la base de datos
        ResultSet rs; // Objeto que nos permite almacenar el resultado obtenido de la base de datos
    ...
    public boolean buscarEstudiantePorId(Estudiante estudiante){
        ...
        try {
            ...
            System.out.println("Ocurrio un erro al buscar estuadiante: "+e.getMessage());
        }//Fin catch
        finally {
            try {
                con.close();
    ...
    public boolean eliminarEstudiante(Estudiante estudiante){
        ...
        return false;
    } // Fin del metodo Eliminar Estudiante
